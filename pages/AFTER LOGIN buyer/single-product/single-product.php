...
<html>
    ...
    <body>
        ...
        <section id="proddetails" class="section-p1">
            ...
            <img source src="<?php echo '../../after login/add item/uploads/' .$image_1;?>" id="MainImg" alt="" height="500" width="550"> 
                <div class="small-img-group">
                    <div class="small-img-col">
                    <img source src="<?php echo '../../after login/add item/uploads/' .$image_2;?>" class="small-img" alt="" height="300" width="350">
                    </div>

                    <div class="small-img-col">
                    <img source src="<?php echo '../../after login/add item/uploads/' .$image_1;?>" class="small-img" alt="" height="300" width="350">
                    </div>
                </div>
            </div>
